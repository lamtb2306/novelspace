(function () {
  ...
  var relativeModuleUrl = new URL("frontend/js/main.js?v=20260531-recent-updated", currentScript).href;

  import(relativeModuleUrl).catch(function (firstError) {
    import("/frontend/js/main.js?v=20260531-recent-updated").catch(function (secondError) {
